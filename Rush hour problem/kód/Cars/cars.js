...
let blueCar = new Car('blue', 3, 6, 3, true);
let greenCar = new Car('green', 3, 2, 4, false);
let greyCar = new Car('grey', 2, 5, 5, true);
let purpleCar = new Car('purple', 3, 1, 6, false);
let pinkCar = new Car('pink', 2, 5, 1, false);
let orangeCar = new Car('orange', 2, 1, 1, true);
